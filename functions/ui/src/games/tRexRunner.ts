...
Runner.prototype = {
  ...
  loadImages: function () {
    if (IS_HIDPI) {
      (Runner as any).imageSprite = document.getElementById(
    ...
    if ((Runner as any).imageSprite.complete) {
      ...
      (Runner as any).imageSprite.addEventListener(
        Runner.events.LOAD,
        this.init.bind(this)
      );
    }
  ...
  loadSounds: function () {
    if (!IS_IOS) {
      ...
      for (var sound in Runner.sounds) {
        var soundSrc = (document.getElementById(
          Runner.sounds[sound]
  ...
  init: function () {
    ...
    (
      document.querySelector("." + Runner.classes.ICON) as any
    ...
    this.canvasCtx.fill();
    Runner.updateCanvasScaling(this.canvas, undefined, undefined);
  ...
  update: function () {
    ...
    if (this.playing) {
      ...
      var collision =
        hasObstacles &&
        checkForCollision(this.horizon.obstacles[0], this.tRex, undefined);
      ...
      if (
        ...
        if (!this.playing) {
          ...
          if ((window as any).errorPageController) {
            (window as any).errorPageController.trackEasterEgg();
          }
        }
...
function DistanceMeter(canvas, spritePos, canvasWidth) {
  this.canvas = canvas;
  this.canvasCtx = canvas.getContext("2d");
  this.image = (Runner as any).imageSprite;
  this.spritePos = spritePos;
  this.x = 0;
  this.y = 5;
